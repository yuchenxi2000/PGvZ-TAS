...
from Sexy import Widget, TRect, Insets, WidgetContainer, FlagsMod, WidgetManager, Graphics, Image, ScrollWidget, DialogListener, Font, DialogButton, TPoint, SexyColor, ButtonListener, AchievementId, KeyCode, SexyChar, Buffer, _Touch, ButtonWidget, SexyVector2, Main, SexyAppBase, Dialog, UI_ORIENTATION, MusicInterface, ResourceManager, ScreenScales, SoundManager, Constants, MemoryImage, LayoutFlags, BufferNew, HyperlinkWidget, TriVertex
from System.Collections.Generic import List_1, LinkedListNode_1, LinkedList_1, Dictionary_2, IReadOnlyList_1, IEnumerable_1
...
from Lawn.Creative import CreativeLevel
...
class AchievementsWidget(Widget):
    ...
    mZOrder : int
    @property
    def ClipInput(self) -> bool: ...
    @ClipInput.setter
    def ClipInput(self, value: bool) -> bool: ...
...
class BackgroundTypeConvertor:
    def __init__(self) -> None: ...
    @staticmethod
    def ToEnum(index: int, version: int) -> BackgroundType: ...
    @staticmethod
    def ToInt(theEnum: BackgroundType, version: int) -> int: ...
...
class Board(Widget, AlmanacListener, ButtonListener):
    ...
    def CanUseCombatTool(self, tool: GameObjectType) -> bool: ...
    ...
    def HasPauseButton(self) -> bool: ...
    def HasProgressMeter(self) -> bool: ...
    def HasRain(self) -> bool: ...
    def HasShovel(self) -> bool: ...
    ...
    def IsCombatToolVisible(self, tool: GameObjectType) -> bool: ...
    ...
    def IsPlantSkillEnabled(self, seedType: SeedType) -> bool: ...
    ...
    def PickZombieTypeSurvival(self, theZombiePoints: int, theWaveIndex: int) -> ZombieType: ...
    ...
    # Skipped PutZombieInWave due to it being static, abstract and generic.

    PutZombieInWave : PutZombieInWave_MethodGroup
    class PutZombieInWave_MethodGroup:
        @typing.overload
        def __call__(self, theZombieType: ZombieType, theWaveNumber: int, theZombiePicker: ZombiePicker) -> None:...
        @typing.overload
        def __call__(self, theZombieType: ZombieType, theWaveNumber: int, theZombiePicker: ZombiePicker, theZombieValue: int) -> None:...
...
class CardPair:
    mImitator : bool
    mSeedType : SeedType
    def Deconstruct(self, theType: clr.Reference[SeedType], theImitator: clr.Reference[bool]) -> None: ...
    # Operator not supported op_Implicit(theType: SeedType)
...
class Challenge(StoreListener):
    ...
    def InitZombieWavesSurvivalComponent(self) -> None: ...
...
class ChallengePage(typing.SupportsInt):
    ...
    DIY : ChallengePage # 6
    OnlineLevel : ChallengePage # 7
    MaxChallengePages : ChallengePage # 8
...
class ChallengeScreen(Widget, ButtonListener):
    ...
    def IndexToGameMode(self, index: int) -> GameMode: ...
    ...
    def ReloadDIYLevels(self) -> None: ...
    def RemovedFromManager(self, theWidgetManager: WidgetManager) -> None: ...
    def SetUnlockChallengeIndex(self, thePage: ChallengePage, aIsIZombie: bool) -> None: ...
    def ShowPageButtons(self) -> bool: ...
    def StartEnterOnlineLevel(self, theGameMode: GameMode, thePreview: OnlineLevelPreview) -> None: ...
    def Update(self) -> None: ...
...
class CutScene(LawnMessageBoxListener):
    ...
    def AddDefaultLadders(self) -> None: ...
    def AddDefaultPlants(self) -> None: ...
...
class DockDirection(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Left : DockDirection # 0
    Right : DockDirection # 1
    Up : DockDirection # 2
    Down : DockDirection # 3


class DockMainMenuButton(MainMenuButton):
    def __init__(self, image: Image, id: int, listener: ButtonListener) -> None: ...
    FullRect : TRect
    mBtnNoDraw : bool
    mButtonImage : Image
    ...
    mZOrder : int
    @property
    def AnimationDuration(self) -> TimeSpan: ...
    @AnimationDuration.setter
    def AnimationDuration(self, value: TimeSpan) -> TimeSpan: ...
    @property
    def ClipInput(self) -> bool: ...
    @ClipInput.setter
    def ClipInput(self, value: bool) -> bool: ...
    @property
    def ExpandDirection(self) -> DockDirection: ...
    @ExpandDirection.setter
    def ExpandDirection(self, value: DockDirection) -> DockDirection: ...
    @property
    def HoldDuration(self) -> TimeSpan: ...
    @HoldDuration.setter
    def HoldDuration(self, value: TimeSpan) -> TimeSpan: ...
    @property
    def IsAnimating(self) -> bool: ...
    @IsAnimating.setter
    def IsAnimating(self, value: bool) -> bool: ...
    @property
    def IsExpanded(self) -> bool: ...
    @IsExpanded.setter
    def IsExpanded(self, value: bool) -> bool: ...
    @property
    def Items(self) -> IReadOnlyList_1[MainMenuButton]: ...
    @property
    def ItemSpacing(self) -> int: ...
    @ItemSpacing.setter
    def ItemSpacing(self, value: int) -> int: ...
    @property
    def mLabel(self) -> str: ...
    @mLabel.setter
    def mLabel(self, value: str) -> str: ...
    def AddItem(self, button: MainMenuButton) -> None: ...
    def AddWidget(self, widget: Widget) -> None: ...
    def Dispose(self) -> None: ...
    def Draw(self, g: Graphics) -> None: ...
    def GetInsetRect(self) -> TRect: ...
    def IsPointVisible(self, x: int, y: int) -> bool: ...
    def MouseDown(self, x: int, y: int, button: int, clickCount: int) -> None: ...
    def MouseDrag(self, x: int, y: int) -> None: ...
    def MouseUp(self, x: int, y: int, button: int, clickCount: int) -> None: ...
    def RemovedFromManager(self, manager: WidgetManager) -> None: ...
    def RemoveItem(self, button: MainMenuButton) -> None: ...
    def RemoveWidget(self, widget: Widget) -> None: ...
    def Resize(self, x: int, y: int, width: int, height: int) -> None: ...
    def SetVisible(self, visible: bool) -> None: ...
    def Update(self) -> None: ...
    # Skipped MakeNewButton due to it being static, abstract and generic.

    MakeNewButton : MakeNewButton_MethodGroup
    class MakeNewButton_MethodGroup:
        @typing.overload
        def __call__(self, id: int, listener: ButtonListener, font: Font, image: Image, x: int = ..., y: int = ...) -> DockMainMenuButton:...
        @typing.overload
        def __call__(self, id: int, listener: ButtonListener, label: str, font: Font, image: Image, x: int = ..., y: int = ...) -> DockMainMenuButton:...
...
class DynamicTachieWidget(Widget):
    ...
    @property
    def State(self) -> DynamicTachieWidget.PlaybackState: ...
    @State.setter
    def State(self, value: DynamicTachieWidget.PlaybackState) -> DynamicTachieWidget.PlaybackState: ...
    def BackButtonPress(self) -> bool: ...
    def Dispose(self) -> None: ...
    def Draw(self, g: Graphics) -> None: ...
    def DrawOverlay(self, g: Graphics) -> None: ...
    ...
    class DisplayTransform(IEquatable_1[DynamicTachieWidget.DisplayTransform]):
        def __init__(self, Scale: float, OffsetX: float, OffsetY: float) -> None: ...
        @property
        ...
        def Deconstruct(self, Scale: clr.Reference[float], OffsetX: clr.Reference[float], OffsetY: clr.Reference[float]) -> None: ...
        def GetHashCode(self) -> int: ...
        def __eq__(self, left: DynamicTachieWidget.DisplayTransform, right: DynamicTachieWidget.DisplayTransform) -> bool: ...
        def __ne__(self, left: DynamicTachieWidget.DisplayTransform, right: DynamicTachieWidget.DisplayTransform) -> bool: ...
        def ToString(self) -> str: ...
        # Skipped Equals due to it being static, abstract and generic.
        ...
        class Equals_MethodGroup:
            @typing.overload
            def __call__(self, other: DynamicTachieWidget.DisplayTransform) -> bool:...
            @typing.overload
            def __call__(self, obj: typing.Any) -> bool:...
    ...
    class PlaybackState(typing.SupportsInt):
        ...
        # Values:
        Entering : DynamicTachieWidget.PlaybackState # 0
        Idle : DynamicTachieWidget.PlaybackState # 1
        PlayingInteraction : DynamicTachieWidget.PlaybackState # 2


    class TouchArea(typing.SupportsInt):
        @typing.overload
        def __init__(self, value : int) -> None: ...
        @typing.overload
        def __init__(self, value : int, force_if_true: bool) -> None: ...
...
class GameConstants:
    ...
    gBossZombieListHard : Array_1[ZombieType]
...
class GameMode(typing.SupportsInt):
    ...
    CreativeLevel : GameMode # 40000
    OnlineLevel : GameMode # 50000
...
class GameSelector(Widget, QuickPlayWidgetListener, MiniGamesWidgetListener, AlmanacListener, StoreListener, ButtonListener):
    ...
    mAdventureHardButton : ToggleButton
    ...
    mOnlineLevelsButton : DockMainMenuButton
    ...
    def FinishAdventureHardConfirmDialog(self) -> None: ...
...
class GameSelectorButtons(typing.SupportsInt):
    ...
    AdventureHard : GameSelectorButtons # 131
    LocalLevels : GameSelectorButtons # 132
...
class GlobalMembersReanimIds(abc.ABC):
    ...
    ReanimTrackId_anim_henshin : str
...
class LawnApp(SexyAppBase):
    ...
    def IsAdventureModeHard(self) -> bool: ...
    ...
    def IsFusionEnabled(self) -> bool: ...
    def IsIceDemo(self) -> bool: ...
    def IsIZombieLevel(self) -> bool: ...
    def IsLevelUseJson(self) -> bool: ...
    ...
    def SetGameMode(self, theGameMode: GameMode) -> None: ...
    ...
    # Skipped IsDIYMode due to it being static, abstract and generic.

    IsDIYMode : IsDIYMode_MethodGroup
    class IsDIYMode_MethodGroup:
        @typing.overload
        def __call__(self) -> bool:...
        @typing.overload
        def __call__(self, theGameMode: GameMode) -> bool:...

    # Skipped IsOnlineLevelMode due to it being static, abstract and generic.

    IsOnlineLevelMode : IsOnlineLevelMode_MethodGroup
    class IsOnlineLevelMode_MethodGroup:
        @typing.overload
        def __call__(self) -> bool:...
        @typing.overload
        def __call__(self, theGameMode: GameMode) -> bool:...
...
class LevelInfoPanel(PulloutPanel, ButtonListener):
    def __init__(self, app: LawnApp, columns: int = ...) -> None: ...
    FullRect : TRect
    mClip : bool
    mColors : List_1[Color]
    mDisabled : bool
    ...
    class ButtonPress_MethodGroup:
        ...
        def __call__(self, id: int) -> None:...
        @typing.overload
        def __call__(self, id: int, count: int) -> None:...



class LevelInfoRichText(ScrollWidget):
    def __init__(self, cache: ReanimatorCache, font: Font, columns: int = ...) -> None: ...
    FullRect : TRect
    mClip : bool
    mColors : List_1[Color]
    mDisabled : bool
    ...
    def Dispose(self) -> None: ...
    def Resize(self, x: int, y: int, width: int, height: int) -> None: ...
    def SetLevel(self, app: LawnApp, rawValues: bool) -> None: ...
...
class MainMenuButton(NewLawnButton):
    ...
    class MakeNewButton_MethodGroup:
        @typing.overload
        def __call__(self, theId: int, theListener: ButtonListener, theFont: Font, theImage: Image, theX: int = ..., theY: int = ...) -> MainMenuButton:...
        @typing.overload
        def __call__(self, theId: int, theListener: ButtonListener, theLabel: str, theFont: Font, theImage: Image, theX: int = ..., theY: int = ...) -> MainMenuButton:...
...
class MusicTuneConvertor:
    def __init__(self) -> None: ...
    @staticmethod
    def ToEnum(index: int, version: int) -> MusicTune: ...
    @staticmethod
    def ToInt(theEnum: MusicTune, version: int) -> int: ...
...
class OnlineLevel(abc.ABC):
    ClientVersion : int
    ClientVersionUrl : str
    ServerBaseUrl : str
    @classmethod
    @property
    def CurrentLevels(cls) -> List_1[OnlineLevelPreview]: ...
    @classmethod
    @property
    def CurrentPage(cls) -> int: ...
    @classmethod
    @property
    ...
    @classmethod
    @property
    def TotalPages(cls) -> int: ...
    @staticmethod
    def ClearCache() -> None: ...
    @staticmethod
    def DownloadLevelDataAsync(preview: OnlineLevelPreview, gameMode: GameMode) -> Task_1[bool]: ...
    @staticmethod
    def InitializeAsync() -> Task: ...
    @staticmethod
    def LoadPageAsync(page: int, sortBy: str = ...) -> Task_1[bool]: ...
    @staticmethod
    def ReloadAsync() -> Task_1[bool]: ...


class OnlineLevelCatalogResponse:
    def __init__(self) -> None: ...
    @property
    def HasMore(self) -> bool: ...
    @HasMore.setter
    def HasMore(self, value: bool) -> bool: ...
    @property
    def Items(self) -> List_1[OnlineLevelPreview]: ...
    @Items.setter
    def Items(self, value: List_1[OnlineLevelPreview]) -> List_1[OnlineLevelPreview]: ...
    @property
    def NextCursor(self) -> str: ...
    @NextCursor.setter
    def NextCursor(self, value: str) -> str: ...
    @property
    def TotalCount(self) -> int: ...
    @TotalCount.setter
    def TotalCount(self, value: int) -> int: ...


class OnlineLevelDialog(LawnDialog):
    def __init__(self, theApp: LawnApp, theGameMode: GameMode, title: str, thePreview: OnlineLevelPreview) -> None: ...
    FullRect : TRect
    mApp : LawnApp
    mBackgroundInsets : Insets
    mButtonDelay : int
...
class OnlineLevelIconInfo:
    def __init__(self) -> None: ...
    @property
    def IconId(self) -> int: ...
    @IconId.setter
    def IconId(self, value: int) -> int: ...
    @property
    def Sha256(self) -> str: ...
    @Sha256.setter
...
class OnlineLevelManager:
    def __init__(self) -> None: ...
    @property
    def CurrentLevels(self) -> List_1[OnlineLevelPreview]: ...
    @CurrentLevels.setter
    def CurrentLevels(self, value: List_1[OnlineLevelPreview]) -> List_1[OnlineLevelPreview]: ...
    @property
    def CurrentPage(self) -> int: ...
    @CurrentPage.setter
    def CurrentPage(self, value: int) -> int: ...
    @property
    ...
    @LastError.setter
    def LastError(self, value: str) -> str: ...
    @property
    def TotalCount(self) -> int: ...
    @TotalCount.setter
    def TotalCount(self, value: int) -> int: ...
    ...
    @TotalPages.setter
    def TotalPages(self, value: int) -> int: ...
    def ClearCache(self) -> None: ...
    def DownloadLevelDataAsync(self, preview: OnlineLevelPreview, gameMode: GameMode) -> Task_1[bool]: ...
    def InitializeAsync(self) -> Task: ...
    def LoadPageAsync(self, page: int, sortBy: str = ...) -> Task_1[bool]: ...
    def ReloadAsync(self) -> Task_1[bool]: ...


class OnlineLevelPayloadInfo:
    def __init__(self) -> None: ...
    @property
    def CompressedSize(self) -> int: ...
    @CompressedSize.setter
    def CompressedSize(self, value: int) -> int: ...
    @property
    def ContentSha256(self) -> str: ...
    @ContentSha256.setter
    def ContentSha256(self, value: str) -> str: ...
    @property
    def Encoding(self) -> str: ...
    @Encoding.setter
    def Encoding(self, value: str) -> str: ...
    @property
    def PayloadSha256(self) -> str: ...
    @PayloadSha256.setter
    def PayloadSha256(self, value: str) -> str: ...
    @property
    def UncompressedSize(self) -> int: ...
    @UncompressedSize.setter
    def UncompressedSize(self, value: int) -> int: ...
    @property
    def Url(self) -> str: ...
    @Url.setter
    def Url(self, value: str) -> str: ...
...
class OnlineLevelPreview:
    ...
    @property
    def CachedIcon(self) -> Image: ...
    @CachedIcon.setter
    def CachedIcon(self, value: Image) -> Image: ...
    @property
    def CachedIconBytes(self) -> Array_1[int]: ...
    @CachedIconBytes.setter
    def CachedIconBytes(self, value: Array_1[int]) -> Array_1[int]: ...
    @property
    def ChineseName(self) -> str: ...
    @property
    def Difficulty(self) -> int: ...
    @Difficulty.setter
    def Difficulty(self, value: int) -> int: ...
    @property
    def Downloads(self) -> int: ...
    @property
    def EnglishName(self) -> str: ...
    @property
    def Icon(self) -> OnlineLevelIconInfo: ...
    @Icon.setter
    def Icon(self, value: OnlineLevelIconInfo) -> OnlineLevelIconInfo: ...
    @property
    def IconId(self) -> int: ...
    @property
    ...
    @IsDataLoaded.setter
    def IsDataLoaded(self, value: bool) -> bool: ...
    @property
    def IsEndless(self) -> bool: ...
    @IsEndless.setter
    def IsEndless(self, value: bool) -> bool: ...
    @property
    def IsRecommended(self) -> bool: ...
    @property
    def LevelId(self) -> str: ...
    @property
    def MinClientVersion(self) -> int: ...
    @MinClientVersion.setter
    def MinClientVersion(self, value: int) -> int: ...
    @property
    def Name(self) -> str: ...
    @property
    def Payload(self) -> OnlineLevelPayloadInfo: ...
    @Payload.setter
    def Payload(self, value: OnlineLevelPayloadInfo) -> OnlineLevelPayloadInfo: ...
    @property
    def PopularityScore(self) -> int: ...
    @PopularityScore.setter
    def PopularityScore(self, value: int) -> int: ...
    @property
    def PublishedAt(self) -> DateTime: ...
    @PublishedAt.setter
    def PublishedAt(self, value: DateTime) -> DateTime: ...
    @property
    def RecommendedRank(self) -> int: ...
    @RecommendedRank.setter
    def RecommendedRank(self, value: int) -> int: ...
    @property
    def RevisionId(self) -> str: ...
    @RevisionId.setter
    def RevisionId(self, value: str) -> str: ...
    @property
    ...
    @TitleEn.setter
    def TitleEn(self, value: str) -> str: ...
    @property
    def TitleZhCn(self) -> str: ...
    @TitleZhCn.setter
    def TitleZhCn(self, value: str) -> str: ...
...
class Plant(GameObject):
    ...
    @staticmethod
    def GetBaseHealth(type: SeedType) -> int: ...
    @staticmethod
...
class PlantState(typing.SupportsInt):
    ...
    PlanternHenshinBegin : PlantState # 76
    PlanternHenshinOver : PlantState # 77
...
class PlayerInfo:
    ...
    mOnlineChallengeRecords : Dictionary_2[str, int]
    ...
    def GetOnlineChallengeRecord(self, levelId: str) -> int: ...
    ...
    def SetOnlineChallengeRecord(self, levelId: str, record: int) -> None: ...
...
class Projectile(GameObject):
    ...
    def GetProjectileDamage(self) -> int: ...
...
class ProjectileTypeConvertor:
    def __init__(self) -> None: ...
    @staticmethod
    def ToEnum(index: int, version: int) -> ProjectileType: ...
    @staticmethod
    def ToInt(theEnum: ProjectileType, version: int) -> int: ...


class PulloutPanel(Widget):
    def __init__(self, handleImage: Image, handleOverlap: int = ..., content: Widget = ..., footer: Widget = ...) -> None: ...
    FullRect : TRect
    mClip : bool
    mColors : List_1[Color]
    mDisabled : bool
    ...
    def RemovedFromManager(self, manager: WidgetManager) -> None: ...
    def Resize(self, x: int, y: int, width: int, height: int) -> None: ...
    def SetExpanded(self, expanded: bool, animate: bool = ...) -> None: ...
    def SetHandleImage(self, image: Image, overlap: int) -> None: ...
    def SetVisible(self, visible: bool) -> None: ...
    def Update(self) -> None: ...
...
class ReanimatorCache:
    ...
    mZombieImageBounds : Dictionary_2[ZombieType, TRect]
    ...
    def DrawCachedZombieThumbnail(self, g: Graphics, x: float, y: float, type: ZombieType) -> None: ...
    ...
    @staticmethod
    def GetZombieFrameOrigin(type: ZombieType) -> TPoint: ...
...
class SeedBank(GameObject):
    ...
    mApp : LawnApp
    mBoard : Board
    mConveyorBeltBuffer : List_1[CardPair]
    mConveyorBeltCounter : int
    mCutSceneDarken : int
    mHeight : int
    mNumPackets : int
    ...
    mX : int
    mY : int
    def AddSeed(self, theSeedType: SeedType, isImitator: bool = ...) -> None: ...
...
class SeedChooserScreen(Widget, SeedPacketsWidgetListener, LawnMessageBoxListener, AlmanacListener, StoreListener):
    ...
    def PreChooseSeed(self, seedType: SeedType, locked: bool, imitator: bool = ...) -> None: ...
...
class SeedPacket(GameObject):
    ...
    def PickNextSlotMachineSeedForJsonLevel(self) -> None: ...
    def SaveToFile(self, b: Buffer) -> bool: ...
...
class SeedType(typing.SupportsInt):
    ...
    ZombieCardFlag : SeedType # 536870912
    MindControlledCardFlag : SeedType # 1073741824
    None_ : SeedType # -1


class SeedTypeConvertor:
    def __init__(self) -> None: ...
    # Skipped ToEnum due to it being static, abstract and generic.

    ToEnum : ToEnum_MethodGroup
    class ToEnum_MethodGroup:
        @typing.overload
        def __call__(self, index: int, version: int) -> CardPair:...
        @typing.overload
        def __call__(self, index: int, isImitator: clr.Reference[bool], version: int) -> SeedType:...

    # Skipped ToInt due to it being static, abstract and generic.

    ToInt : ToInt_MethodGroup
    class ToInt_MethodGroup:
        @typing.overload
        def __call__(self, thePair: CardPair, version: int) -> int:...
        @typing.overload
        def __call__(self, theEnum: SeedType, isImitator: bool, version: int) -> int:...
...
class TypeNameSpace(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Raw : TypeNameSpace # 0
    PlantGirls : TypeNameSpace # 2000
    ImitatorCard : TypeNameSpace # 10000
    ZombieCard : TypeNameSpace # 20000
    MindControlledCard : TypeNameSpace # 30000
    None_ : TypeNameSpace # -1
...
class ZenGarden(ButtonListener, StoreListener):
    ...
    def InteractionFocusOnPlant(self, thePlant: Plant, theScale: float, cd: int) -> None: ...
...
class Zombie(GameObject, IComparable):
    ...
    @staticmethod
    def GetBaseBodyHealth(type: ZombieType, app: LawnApp) -> int: ...
    @staticmethod
    def GetBaseFlyingHealth(type: ZombieType) -> int: ...
    @staticmethod
    def GetBaseHelmHealth(type: ZombieType) -> int: ...
    @staticmethod
    def GetBaseShieldHealth(type: ZombieType) -> int: ...
    ...
    @staticmethod
    def GetPlacementPreviewOrigin(board: Board, type: ZombieType, col: int, row: int, mindControlled: bool = ...) -> Vector2: ...
    ...
    def IsOnHighGround(self) -> bool: ...
    @staticmethod
    def IsPlacementPreviewMirrored(type: ZombieType, mindControlled: bool) -> bool: ...
    ...
    @staticmethod
    def ZombieTypeCanGoInPoolDefault(theZombieType: ZombieType) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def ZombieTypeCanGoOnHighGroundDefault(theZombieType: ZombieType) -> bool: ...
...
class ZombieTypeConvertor:
    def __init__(self) -> None: ...
    @staticmethod
    def ToEnum(index: int, version: int) -> ZombieType: ...
    @staticmethod
    def ToInt(theEnum: ZombieType, version: int) -> int: ...
