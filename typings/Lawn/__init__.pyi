...
class PlantVoice(abc.ABC):
    ...
    class VoiceType(typing.SupportsInt):
        ...
        NumSpecialTypes : PlantVoice.VoiceType # 29
...
class ProjectileType(typing.SupportsInt):
    ...
    ProjectilesCount : ProjectileType # 21
...
class SeedPacket(GameObject):
    ...
    def DrawOverlay(self, g: Graphics) -> None: ...
    @staticmethod
    def DrawSmallSeedPacket(g: Graphics, x: float, y: float, theSeedType: SeedType, theImitaterType: SeedType, thePercentDark: float, theGrayness: int, theDrawCost: bool, theUseCurrentCost: bool, theDrawBackground: bool, theDrawCostBackground: bool) -> None: ...
...
class SeedType(typing.SupportsInt):
    ...
    SeedTypeCount : SeedType # 60
    BeghouledButtonShuffle : SeedType # 61
    BeghouledButtonCrater : SeedType # 62
    SlotMachineSun : SeedType # 63
    SlotMachineDiamond : SeedType # 64
    ZombiquariumSnorkel : SeedType # 65
    ZombiquariumTrophy : SeedType # 66
    ZombieNormal : SeedType # 67
    ZombieTrafficCone : SeedType # 68
    ZombiePolevaulter : SeedType # 69
    ZombiePail : SeedType # 70
    ZombieLadder : SeedType # 71
    ZombieDigger : SeedType # 72
    ZombieBungee : SeedType # 73
    ZombieFootball : SeedType # 74
    ZombieBalloon : SeedType # 75
    ZombieScreenDoor : SeedType # 76
    Zomboni : SeedType # 77
    ZombiePogo : SeedType # 78
    ZombieDancer : SeedType # 79
    ZombieGargantuar : SeedType # 80
    ZombieImp : SeedType # 81
    None_ : SeedType # -1
