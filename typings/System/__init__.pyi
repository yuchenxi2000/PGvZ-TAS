...
class Func_2(typing.Generic[Func_2_T, Func_2_TResult], MulticastDelegate):
    ...
    def __call__(self, hookFunc: typing.Any): ...
...
class SequencePosition(IEquatable_1[SequencePosition]):
    def __init__(self, object: typing.Any, integer: int) -> None: ...
    def GetHashCode(self) -> int: ...
    ...
    class Equals_MethodGroup:
        @typing.overload
        def __call__(self, other: SequencePosition) -> bool:...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool:...
